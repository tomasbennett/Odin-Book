            ...
            const buildReplies = Promise.all(
                repliesDb.map(async (reply): Promise<IPost> => {
                    ...
                    return {
                        ...
                        commentCount: reply.descendantCommentsCount,
            ...
            const buildParentPosts = Promise.all(
                parentPostsDb.map(async (parentPost): Promise<IPost> => {
                    ...
                    return {
                        ...
                        commentCount: parentPost.descendantCommentsCount,
...
router.get("/:postId/comments",
    ...
    async (req: Request<{ postId: string }>, res: Response<IPostCommentsThreadAPI | ICustomErrorResponse>, next: NextFunction) => {
        ...
        try {
            ...
            //NEED A COMMENT FOR DISPLAY AND THE ALL COMMENTS FOR COUNT
            ...
            const buildPost = async () => {
                ...
                const postsApi: IPost = {
                    ...
                    commentCount: postDb.descendantCommentsCount,
